...
When I’m not coding, I’m learning, experimenting, and pushing myself to grow as a developer and as an upcoming cybersecurity expert. 🚀`,
    project: [
        { id: 1, siteName: 'LogiXpress', about: `LogiXpress is a modern logistics platform that makes shipping and package tracking fast, reliable, and effortless.
Users can create shipments, track them in real-time, and manage deliveries with ease.
The platform features a responsive and intuitive UI, built with React and Tailwind CSS.
It integrates with a backend API for real-time updates and seamless data management.
LogiXpress empowers users to stay in control of their shipments, anytime, anywhere.`, react: 'react', tailwind: 'tailwind', link: 'https://logixpress.vercel.app/', github: 'https://github.com/Fatzy070/logistic-front', image: logi , node: 'Node.js' },
        { id: 1, siteName: 'learnhub', about: 'LearnHub is a modern mini-LMS platform designed to make learning simple, organized, and accessible. It provides a clean interface where students can explore courses, watch lessons, track progress, and manage their learning journey without distractions. The platform includes features such as video playback, user authentication, progress saving, and structured course organization all built to deliver a smooth, efficient learning experience.', react: 'react', tailwind: 'tailwind', link: 'https://learnhub-henna.vercel.app/', github: 'https://github.com/Fatzy070/learn-front', image: learn , node: 'Node.js' },
        { id: 2, siteName: 'Zyntek', about: 'A modern e-commerce website that combines tech and fashion into one platform. It features a clean UI, responsive layouts, dynamic product displays, and smooth navigation for an elegant shopping experience. The project highlights my frontend skills in React, Tailwind CSS, and responsive web design, with a focus on performance and visual consistency across devices.', react: 'react', tailwind: 'tailwind', link: 'https://zyntek-silk.vercel.app/', github: 'https://github.com/Fatzy070/Zyntek-front', image: zyntek , node: 'Node.js' },
        { id: 3, siteName: 'Fintech', about: 'A modern fintech app that simplifies personal finance by helping users track expenses, monitor savings, and make smarter financial decisions. Built with cutting-edge web technologies, it combines a sleek, responsive interface with secure, real-time features for seamless money management.', react: 'react', tailwind: 'tailwind', link: 'https://naijafintech.vercel.app/', github: 'https://github.com/Fatzy070/tracker-frontend', image: fintech, node: 'Node.js' },
        { id: 4, siteName: 'CryptoNova', about: 'A live cryptocurrency portfolio tracker that lets users monitor their crypto assets in real time. Built with React.js and integrated with live market APIs, CryptoNova features Google login, smooth portfolio management, and a clean, interactive dashboard.', react: 'react', tailwind: 'tailwind', link: 'https://crypto-nova-neon.vercel.app/', github: 'https://github.com/Fatzy070/CryptoNova-frontend', image: cryptoNova, node: 'Node.js' },
        { id: 5, siteName: 'Blog', about: 'This is a mini social media/blog application built with React, Firebase, and Tailwind CSS. Users can create accounts, login via email or Google, edit their profiles, and create posts with text, images, or videos.', react: 'react', tailwind: 'tailwind', link: 'https://blogwebapp-red.vercel.app/', github: 'https://github.com/Fatzy070/blogwebapp', image: blog, node: 'firebase' },
        { id: 6, siteName: 'crypgo', about: 'A modern cRryptocurrency tracker that provides users with real-time data on various coins. Built with React and TailwindCSS for a sleek interface, and Node.js for backend operations, Crypgo delivers a smooth experience for monitoring and exploring crypto trends.', react: 'react', tailwind: 'tailwind', link: 'https://crypto-psi-five-92.vercel.app/', github: 'https://github.com/Fatzy070/crypto-frontend', image: crypto, node: 'node.js' },
        { id: 7, siteName: 'dashboard', about: 'An interactive admin dashboard that visualizes key metrics and data in a clean interface. Built with React and TailwindCSS for the frontend and Node.js on the backend, this project demonstrates dynamic data fetching, state management, and responsive design for real-world business use cases.', react: 'react', tailwind: 'tailwind', link: 'https://dashboard-blond-five-33.vercel.app/', github: 'https://github.com/Fatzy070/dashboard', image: dashboard, node: 'node.js' },
        { id: 8, siteName: 'YouthVenture', about: 'An engaging travel and adventure website designed for young explorers. YouthVenture showcases destinations, experiences, and stories with a responsive design powered by React and TailwindCSS, while Node.js ensures seamless backend support.', react: 'react', tailwind: 'tailwind', link: 'https://traveller-coral.vercel.app/', github: 'https://github.com/Fatzy070/traveller', image: youth, node: 'node.js' },
        { id: 9, siteName: 'weatherApp', html: 'html', css: 'css', github: 'https://github.com/Fatzy070/liveweather', link: 'https://liveweather-inky.vercel.app/', image: weather, about: 'A real-time weather application that allows users to search and view live weather conditions of any city worldwide. Built with HTML, CSS, and JavaScript, it integrates with a weather API to display accurate data including temperature, humidity, and weather descriptions in a clean and responsive interface.', javascript: 'Javascript' }
    ],
    exp: 'experience',
